...
int main()
{
    ...
    while(t--)
    {
        ...
        /*
        string s = to_string(n - k - l - 1);
        string s1 = to_string(k + l + 1);
        string sn = to_string(n);
        string sk = to_string(k);
        string sl = to_string(l);

        ll ans1 = stoll(multiply(sn,s));

        ll ans2 = k + l;
        ll ans3 = stoll(multiply(sk,sl));
        ...
        */
        ...
        if(k+l < n)
        {
            cout << k*(n-k) + (l)*(n-k-l) + (n-k-l)*(n-k-l-1)/2 << endl;
        }
        else
        {
            ll both = k+l-n;
